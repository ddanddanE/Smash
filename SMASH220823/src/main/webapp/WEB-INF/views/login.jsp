      ...
      <div class="text-center mb-5">
        <form class="form-signin border shadow " action="/user/logincheck" method="post">
          ...
          <!-- <div class="checkbox mb-3">
            <label>
              <input type="checkbox" value="remember-me" name="idcookie"> 아이디 기억하기
            </label>
          </div> -->

          <button class="btn btn-lg btn-primary btn-block" type="submit">로그인</button>
          <p class="mt-3">아이디가 없으세요? <a class="font-weight-bold" href="/join">회원가입</a></p>
          <p class="mt-1 mb-3">아이디를 잊으셨나요? <a class="font-weight-bold" href="findid">아이디 찾기</a></p>
          <p class="mt-1 mb-3">비밀번호를 잊으셨나요? <a class="font-weight-bold" href="findpw">비밀번호 찾기</a></p>
        </form>
      </div>
